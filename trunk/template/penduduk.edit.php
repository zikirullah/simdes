              ...
              <table border="0" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td style="padding: 2px"><input type="text" id="rt" name="rt" value="<? echo htmlentities($rt) ?>" style="width: 250px"/></td>
                  </tr>
                  <tr>
                    <td><strong>RW</strong></td>
                    <td style="padding: 2px"><input type="text" id="rw" name="rw" value="<? echo htmlentities($rw) ?>" style="width: 250px"/></td>
                  </tr>
                  <tr>
                    <td><strong>Tempat Lahir </strong></td>
                    <td style="padding: 2px"><input type="text" id="tempatLahir" name="tempatLahir" value="<? echo htmlentities($tempatLahir) ?>" style="width: 250px"/></td>
                  </tr>
                  <tr>
...
printOptions($M_GENDER, $kelamin); ?>
                ...
                <tbody id="dPendidikan" style="display:none;">
                  <tr>
                    <td><strong>Pendidikan</strong></td>
                    <td style="padding: 2px"><input type="text" id="pendidikan" name="pendidikan" value="<? echo htmlentities($pendidikan) ?>" style="width: 250px"/></td>
                  </tr>
                </tbody>
                <tbody>
                  <tr>
                    <td><strong>Suku</strong></td>
                    <td style="padding: 2px"><input type="text" id="suku" name="suku" value="<? echo htmlentities($suku) ?>" style="width: 250px"/></td>
                  </tr>
                  <tr>
