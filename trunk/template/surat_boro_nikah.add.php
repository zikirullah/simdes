...
<script type="text/javascript" src="javascript/surat_boro_nikah.add.js"></script>
  ...
  <div class="form-region">
    <table border="0" cellspacing="0" width="100%">
      ...
      <tr>
        ...
        <td style="padding: 2px"><input name="hinggaTgl" type="text" id="hinggaTgl" value="<? echo $content['hinggaTgl']; ?>" style="width: 250px"/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2"><table class="data-pengikut" border="0" cellspacing="0" width="100%">
            ...
            <tr>
              ...
              <td><input name="pengikut_kelamin_1" type="text" id="pengikut_kelamin_1"value="<? echo $content['pengikut_kelamin_1']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_1" type="text" id="pengikut_kawin_1"value="<? echo $content['pengikut_kawin_1']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_1" type="text" id="pengikut_pendidikan_1"value="<? echo $content['pengikut_pendidikan_1']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_1" type="text" id="pengikut_noKtp_1"value="<? echo $content['pengikut_noKtp_1']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_1" type="text" id="pengikut_ket_1" value="<? echo $content['pengikut_ket_1']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>2.</td>
              ...
              <td><input name="pengikut_kelamin_2" type="text" id="pengikut_kelamin_2" value="<? echo $content['pengikut_kelamin_2']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_2" type="text" id="pengikut_kawin_2" value="<? echo $content['pengikut_kawin_2']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_2" type="text" id="pengikut_pendidikan_2" value="<? echo $content['pengikut_pendidikan_2']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_2" type="text" id="pengikut_noKtp_2" value="<? echo $content['pengikut_noKtp_2']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_2" type="text" id="pengikut_ket_2" value="<? echo $content['pengikut_ket_2']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>3.</td>
              ...
              <td><input name="pengikut_kelamin_3" type="text" id="pengikut_kelamin_3" value="<? echo $content['pengikut_kelamin_3']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_3" type="text" id="pengikut_kawin_3" value="<? echo $content['pengikut_kawin_3']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_3" type="text" id="pengikut_pendidikan_3" value="<? echo $content['pengikut_pendidikan_3']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_3" type="text" id="pengikut_noKtp_3" value="<? echo $content['pengikut_noKtp_3']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_3" type="text" id="pengikut_ket_3" value="<? echo $content['pengikut_ket_3']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>4.</td>
              ...
              <td><input name="pengikut_kelamin_4" type="text" id="pengikut_kelamin_4" value="<? echo $content['pengikut_kelamin_4']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_4" type="text" id="pengikut_kawin_4" value="<? echo $content['pengikut_kawin_4']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_4" type="text" id="pengikut_pendidikan_4" value="<? echo $content['pengikut_pendidikan_4']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_4" type="text" id="pengikut_noKtp_4" value="<? echo $content['pengikut_noKtp_4']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_4" type="text" id="pengikut_ket_4" value="<? echo $content['pengikut_ket_4']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>5.</td>
              ...
              <td><input name="pengikut_kelamin_5" type="text" id="pengikut_kelamin_5" value="<? echo $content['pengikut_kelamin_5']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_5" type="text" id="pengikut_kawin_5" value="<? echo $content['pengikut_kawin_5']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_5" type="text" id="pengikut_pendidikan_5" value="<? echo $content['pengikut_pendidikan_5']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_5" type="text" id="pengikut_noKtp_5" value="<? echo $content['pengikut_noKtp_5']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_5" type="text" id="pengikut_ket_5" value="<? echo $content['pengikut_ket_5']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>6.</td>
              ...
              <td><input name="pengikut_kelamin_6" type="text" id="pengikut_kelamin_6" value="<? echo $content['pengikut_kelamin_6']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_6" type="text" id="pengikut_kawin_6" value="<? echo $content['pengikut_kawin_6']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_6" type="text" id="pengikut_pendidikan_6" value="<? echo $content['pengikut_pendidikan_6']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_6" type="text" id="pengikut_noKtp_6" value="<? echo $content['pengikut_noKtp_6']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_6" type="text" id="pengikut_ket_6" value="<? echo $content['pengikut_ket_6']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>7.</td>
              ...
              <td><input name="pengikut_kelamin_7" type="text" id="pengikut_kelamin_7" value="<? echo $content['pengikut_kelamin_7']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_7" type="text" id="pengikut_kawin_7" value="<? echo $content['pengikut_kawin_7']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_7" type="text" id="pengikut_pendidikan_7" value="<? echo $content['pengikut_pendidikan_7']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_7" type="text" id="pengikut_noKtp_7" value="<? echo $content['pengikut_noKtp_7']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_7" type="text" id="pengikut_ket_7" value="<? echo $content['pengikut_ket_7']; ?>" style="width: 100%"/>
              </td>
            </tr>
            <tr>
              <td>8.</td>
              ...
              <td><input name="pengikut_kelamin_8" type="text" id="pengikut_kelamin_8" value="<? echo $content['pengikut_kelamin_8']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_kawin_8" type="text" id="pengikut_kawin_8" value="<? echo $content['pengikut_kawin_8']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_pendidikan_8" type="text" id="pengikut_pendidikan_8" value="<? echo $content['pengikut_pendidikan_8']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_noKtp_8" type="text" id="pengikut_noKtp_8" value="<? echo $content['pengikut_noKtp_8']; ?>" style="width: 100%"/>
              </td>
              <td><input name="pengikut_ket_8" type="text" id="pengikut_ket_8" value="<? echo $content['pengikut_ket_8']; ?>" style="width: 100%"/>
              </td>
            </tr>
          </table></td>
      </tr>
