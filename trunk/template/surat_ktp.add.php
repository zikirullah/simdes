...
<script type="text/javascript" src="javascript/surat_ktp.add.js"></script>
<form id="form1" method="post" action="index.php?form=C.02">
  <div class="form-region">
    ...
    <tr>
      ...
      <td style="padding: 2px"><input name="status" type="text" id="status" value="<? echo $content['status']; ?>" style="width: 250px"/></td>
    </tr>
    <tr>
...
<td style="padding: 2px"><select style="width: 254px" id="kAgama" name="kAgama">
    ...
    <tr>
      <td style="padding: 10px 2px 2px 2px"><input class="formbutton" type="button" name="batal" id="batal" value="&laquo; BATAL"/></td>
             <td style="padding: 10px 171px 2px 2px"><div align="right">
