...
<table width="700" align="center" border="0">
  <tr>
    <td colspan="4"><div align="center"><strong>SURAT KETERANGAN PINDAH</strong></div></td>
  </tr>
  <tr>
    <td width="25%">&nbsp;</td>
    <td width="22%"><div align="right">Nomor</div></td>
    <td width="28%">: <? echo $content['noSurat'] ; ?></td>
    <td width="25%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td>Dari Tanggal</td>
    <td colspan="2">: <? echo $content['dariTgl']; ?></td>
  </tr>
  <tr>
    <td>Alasan Pindah</td>
