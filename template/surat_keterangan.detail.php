  <div class="form-region">
    ...
    <tr>
      <td width="24%"><strong>Nomor Surat</strong></td>
      <td width="76%" style="padding: 2px"><? echo $content['noSurat'] ; ?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="padding: 2px"><? echo $content['sekolah']; ?></td>
    </tr>
    <tr>
      <td><strong>Kelas</strong></td>
      <td style="padding: 2px"><? echo $content['kelas']; ?></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><strong>Agama</strong></td>
      <td style="padding: 2px"><?php echo $M_AGAMA[$content['kAgamaOrtu']]; ?></td>
    </tr>
    <tr>
